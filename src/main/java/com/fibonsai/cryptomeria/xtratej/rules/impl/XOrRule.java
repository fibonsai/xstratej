...
public class XOrRule extends RuleStream {
    ...
    public XOrRule(@Nonnull String name, @Nonnull JsonNode properties) {
        this(name, properties, new Fifo<>());
    }

    public XOrRule(@Nonnull String name, @Nonnull JsonNode properties, @Nonnull Fifo<ITemporalData> results) {
