...
public class AndRule extends RuleStream {
    ...
    public AndRule(@Nonnull String name, @Nonnull JsonNode properties) {
        this(name, properties, new Fifo<>());
    }

    public AndRule(@Nonnull String name, @Nonnull JsonNode properties, @Nonnull Fifo<ITemporalData> results) {
